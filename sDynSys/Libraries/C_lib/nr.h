/* 
    ...
    Date created: 	Numerical Recepies file.
    Revised:        2008-03-26 SMT Commented the select functions because it was not possible to compile with it. 
                                   These functions also exists in the winsock library.
